...
import { Dumbbell, Activity, Timer, Plus } from 'lucide-react';
          ...
          return (
            ...
            >
              ...
              <div>
                ...
                <span className="block text-xs text-muted-foreground uppercase mt-0.5">{exercise.unit === 'reps' ? t('home.reps') : t('home.mins')}</span>
              </div>
            </button>
          );
        })}
