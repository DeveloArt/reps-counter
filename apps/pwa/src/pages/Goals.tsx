...
import { endOfDay, endOfWeek, startOfDay, startOfWeek, startOfMonth, endOfMonth, eachDayOfInterval, format } from 'date-fns';
import { useLiveQuery } from 'dexie-react-hooks';
import { Plus, Target, TrendingUp, Dumbbell, Activity, Timer } from 'lucide-react';
      ...
      const goalsToEvaluate =
        ...
        goalsToEvaluate.forEach((goal) => {
          ...
          if (goal.type === 'daily') {
            ...
            // Only evaluate weekly goals on Sundays
            if (format(day, 'i') !== '7') {
